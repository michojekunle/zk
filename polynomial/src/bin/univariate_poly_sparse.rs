...
fn main() {
    ...
    let dense_poly_1_eval_2 = dense_poly_1.evaluate(2.0);
    let dense_poly_1_eval_3 = dense_poly_1.evaluate(3.0);

    assert_eq!(dense_poly_1_degree, 1);
    assert_eq!(dense_poly_1_eval_2, 9.0);
    assert_eq!(dense_poly_1_eval_3, 11.0);
    ...
    let dense_poly_2 = DenseUnivariatePoly {
        coefficients: vec![5.0, 2.0, 3.0],
    };

    let dense_poly_2_degree = dense_poly_2.degree();
    let dense_poly_2_eval_2 = dense_poly_2.evaluate(2.0);
    let dense_poly_2_eval_3 = dense_poly_2.evaluate(3.0);

    assert_eq!(dense_poly_2_degree, 2);
    assert_eq!(dense_poly_2_eval_2, 21.0);
    assert_eq!(dense_poly_2_eval_3, 38.0);
...
mod tests {
    ...
    fn test_dense_polynomials() {
        let poly = DenseUnivariatePoly {
            coefficients: vec![4.0, 3.0, 2.0, 1.0],
        };
        assert_eq!(poly.degree(), 3);
        assert_eq!(poly.evaluate(2.0), 26.0);
        assert_eq!(poly.evaluate(3.0), 58.0);
